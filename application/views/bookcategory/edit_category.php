...
<div class="panel panel-default panel-xs">
    ...
    <div class="panel-footer">
        ...
        <div class="form-group">
            <button onclick="window.history.back();" type="button" class="btn btn-info"><span class="glyphicon glyphicon-floppy-remove">&nbsp;Cancel</span></button>
            <button id="send" type="submit" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-floppy-disk "></span>&nbsp;Save</button> 	
        </div>
    </div>
</form>
</div>  
