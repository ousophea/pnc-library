...
<?php echo form_error('barcode'); ?>
                ...
                <div class="box-footer">
                    ...
                    <div class="form-group">
                        <button onclick="window.history.back();" type="button" class="pull-left btn btn-info"><span class="glyphicon glyphicon-floppy-remove lyphicon-white">&nbsp;Cancel</span></button>
                        <button id="send" type="submit" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-floppy-disk glyphicon-white"></span>&nbsp;Save</button> 
                    </div>
                </div>
                <?php
                // close form
