        ...
        if (isset($_POST['btnImport'])) {
            ...
            if (!empty($_FILES['excelFile']['tmp_name'])) {
                ...
                if ($fileName[1] == 'xlsx'|| $fileName[1] == 'xls'){
                    $objectPHPExcel = PHPExcel_IOFactory::load($_FILES['excelFile']['tmp_name']);
...
//                        echo $worksheet->getCellByColumnAndRow(3, $row)->getValue() . " == ";
                            ...
                            $condition = array_search($worksheet->getCellByColumnAndRow(8, $row)->getValue(), $conditionName); //replace name category by a id get from db;
                            $keywords = $worksheet->getCellByColumnAndRow(9, $row)->getValue();
                            $category_id = array_search($worksheet->getCellByColumnAndRow(10, $row)->getValue(), $catName); //replace name category by a id get from db
